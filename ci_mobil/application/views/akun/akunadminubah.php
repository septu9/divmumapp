			...
			<form class="form-horizontal" action="<?= base_url().'akunadmin/update'?>" method="post">
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input id="name" name="nama_lengkap" type="text" placeholder="Nama Lengkap" class="form-control" value="<?=$akun->nama_lengkap?>">
							<br/>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-10">
							<input id="name" name="email" type="email" placeholder="Email" class="form-control" value="<?=$akun->email?>">
							<br/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input id="name" name="telepon" type="text" placeholder="telepon" class="form-control" value="<?=$akun->telepon?>">
							<br/>
						</div>
					</div>
					<div class="form-group">
