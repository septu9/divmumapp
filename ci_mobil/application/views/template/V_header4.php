    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
          ...
          <a class="navbar-brand" href="<?php echo base_url() ?>Pendistribusian/index"><span>YBM PLN</span> Pendistribusian dan pendayagunaan</a>
      ...
      <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
          <li class="active"><a href="<?php echo base_url() ?>mobil/pendistribusian/index"><em class="fa fa-home">&nbsp;</em> Home </a></li>
          ...
          <ul class="children collapse" id="sub-item-1">
            <li><a href="<?php echo base_url() ?>mobil/Pendistribusian/Pendistribusian">
              <span class="fa fa-users">&nbsp;</span> Form Peminjaman Mobil
            </a></li>
            <li><a class="" href="<?php echo base_url() ?>mobil/Pendistribusian/table">
              <span class="fa fa-users">&nbsp;</span> Data Peminjaman Mobil
            </a></li>
            <li><a class="" href="<?php echo base_url() ?>mobil/Pendistribusian/pendistribusiansemua">
        ...
        <ul class="children collapse" id="sub-item-2">
          <li><a class="" href="<?php echo base_url() ?>ruangrapat/pendistribusian/pendistribusian">
            <span class="fa fa-building">&nbsp;</span> Form Booking Ruang rapat
          </a></li>
          <li><a class="" href="<?php echo base_url() ?>ruangrapat/pendistribusian/table">
            <span class="fa fa-users">&nbsp;</span> Data Peminjaman Ruang
          </a></li>
          <li><a class="" href="<?php echo base_url() ?>ruangrapat/pendistribusian/pendistribusiansemua">
            <span class="fa fa-users">&nbsp;</span> Data Semua Peminjaman 
          </a></li>
        </ul>
      <li><a href="<?=base_url().'profil/pendistribusian/index'?>"><em class="fa fa-user">&nbsp;</em> Profil</a></li>
    </ul>
  </div><!--/.sidebar-->