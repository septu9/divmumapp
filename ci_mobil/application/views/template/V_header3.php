    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
          ...
          <a class="navbar-brand" href="<?php echo base_url() ?>keuangan/index"><span>YBM PLN</span> Keuangan dan Umum</a>
      ...
      <ul class="nav menu">
        <li class="active"><a href="<?php echo base_url() ?>mobil/Keuangan/index"><em class="fa fa-home">&nbsp;</em> Home </a></li>
        ...
        <ul class="children collapse" id="sub-item-1">
          <li><a href="<?php echo base_url() ?>mobil/Keuangan/Keuangan">
            <span class="fa fa-users">&nbsp;</span> Form Peminjaman Mobil
          </a></li>
          <li><a class="" href="<?php echo base_url() ?>mobil/Keuangan/table">
            <span class="fa fa-users">&nbsp;</span> Data Peminjaman Mobil
          </a></li>
          <li><a class="" href="<?php echo base_url() ?>mobil/Keuangan/keuangansemua">
      ...
      <ul class="children collapse" id="sub-item-2">
        <li><a class="" href="<?php echo base_url() ?>ruangrapat/keuangan/Keuangan">
          <span class="fa fa-building">&nbsp;</span> Form Peminjaman Ruang 
        </a></li>
        <li><a class="" href="<?php echo base_url() ?>ruangrapat/keuangan/table">
          <span class="fa fa-users">&nbsp;</span> Data Peminjaman Ruang
        </a></li>
        <li><a class="" href="<?php echo base_url() ?>ruangrapat/keuangan/keuangansemua">
          <span class="fa fa-users">&nbsp;</span> Data Semua Peminjaman 
        </a></li>
      </ul>
    </li>
    <li><a href="<?=base_url().'profil/keuangan/index'?>"><em class="fa fa-user">&nbsp;</em> Profil</a></li>
  </ul>
  </div><!--/.sidebar-->