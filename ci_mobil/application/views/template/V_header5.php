    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#sidebar-collapse"><span class="sr-only">Toggle navigation</span>
          ...
          <a class="navbar-brand" href="<?php echo base_url() ?>kepatuhan/index"><span>YBM PLN</span> kepatuhan hukum dan sdm</a>
      ...
      <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
        ...
        <ul class="nav menu">
          <li class="active"><a href="<?php echo base_url() ?>mobil/Kepatuhan/index"><em class="fa fa-home">&nbsp;</em> Home </a></li>
          ...
          <ul class="children collapse" id="sub-item-1">
            <li><a href="<?php echo base_url() ?>mobil/Kepatuhan/Kepatuhan">
              <span class="fa fa-users">&nbsp;</span> Form Peminjaman Mobil
            </a></li>
            <li><a class="" href="<?php echo base_url() ?>mobil/Kepatuhan/table">
              <span class="fa fa-users">&nbsp;</span> Data Peminjaman Mobil
            </a></li>
            <li><a class="" href="<?php echo base_url() ?>mobil/Kepatuhan/kepatuhansemua">
        ...
        <ul class="children collapse" id="sub-item-2">
          <li><a class="" href="<?php echo base_url() ?>ruangrapat/kepatuhan/kepatuhan">
            <span class="fa fa-building">&nbsp;</span> Form Peminjaman Ruang 
          </a></li>
          <li><a class="" href="<?php echo base_url() ?>ruangrapat/kepatuhan/table">
            <span class="fa fa-users">&nbsp;</span> Data Peminjaman Ruang 
          </a></li>
          <li><a class="" href="<?php echo base_url() ?>ruangrapat/kepatuhan/kepatuhansemua">
            <span class="fa fa-users">&nbsp;</span> Data Semua Peminjaman 
          </a></li>
        </ul>
      </li>
      <li><a href="<?=base_url().'profil/kepatuhan/index'?>"><em class="fa fa-user">&nbsp;</em> Profil</a></li>
    </ul>
  </div><!--/.sidebar-->