...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<form class="form-horizontal" action="<?= base_url().'ruangrapat/kepatuhan/kepatuhan'?>" method="post">
				<fieldset>
					<!-- Name input-->
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<textarea class="form-control" id="message" name="agenda_meeting" placeholder="Agenda Rapat" rows="5"></textarea>
							<br>
					...
					<div class="form-group">
						<div class="col-md-12 widget-right">
							<div class="baten">
								...
								<a href="<?=base_url().'mobil/kepatuhan/index';?>" class="btn btn-danger">Cancel</a>
							</div>
						</div>
					</div>
