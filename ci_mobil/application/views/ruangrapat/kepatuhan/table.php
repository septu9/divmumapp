<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.10.16/css/dataTables.bootstrap4.min.css"><style>
.baten {
	float: right;
}
.baten1 {
			...
			<div class="panel-body btn-margins">
				<div class="col-md-12">
					...
					<td>
						...
						<a href="<?= base_url(); ?>ruangrapat/kepatuhan/ubah/<?= $b['id_booking'] ?> " class="btn btn-sm btn-warning btn-circle "><li class="fa fa-pencil"></li> </a>

						<a href="<?= base_url(); ?>ruangrapat/kepatuhan/detail/<?= $b['id_booking'] ?> " class="btn btn-sm btn-info btn-circle "><li class="fa fa-list-alt"></li> </a></td>
