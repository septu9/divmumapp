		...
		<div class="panel panel-info">
			...
			<div class="panel-body">
				<?php foreach ($booking as $b) :?>
					<form class="form-horizontal" action="<?=base_url().'ruangrapat/kepatuhan/update';?>" method="post">
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input id="divisi" name="" type="text" value="Kepatuhan Hukum dan SDM" placeholder="" class="form-control" readonly>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-2 control-label" for="name">Nama Lengkap</label>
								<div class="col-md-10">
									<input id="nama_lengkap" name="nama_lengkap" type="text" placeholder="Your name" class="form-control" value="<?=$user;?>" readonly>
									<br/>
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<textarea maxlength="50" class="form-control" id="message" name="agenda_meeting" placeholder="Agenda Meeting" rows="5" ></textarea>
									<br>
						...
						<div class="form-group">
							<div class="col-md-12 widget-right">
								<div class="baten">
									...
									<div class="baten1">
										<a href="<?=base_url().'ruangrapat/kepatuhan/table'?>" class="btn btn-danger">Cancel</a>
									</div>
								</div>
							</div>
