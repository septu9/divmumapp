				...
				<div class="panel-body btn-margins">
					<div class="col-md-12">
						...
						<td>
							...
							<a href="<?= base_url(); ?>ruangrapat/penghimpunan/ubah/<?= $b['id_booking'] ?> " class="btn btn-sm btn-warning btn-circle "><li class="fa fa-pencil"></li> </a>
							<a href="<?= base_url(); ?>ruangrapat/penghimpunan/detail/<?= $b['id_booking'] ?> " class="btn btn-sm btn-info btn-circle "><li class="fa fa-list-alt"></li> </a>
						</td>
