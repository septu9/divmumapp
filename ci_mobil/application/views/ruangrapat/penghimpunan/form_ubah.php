		...
		<div class="panel panel-info">
			...
			<?php foreach ($booking as $b):?>
				<div class="panel-body">
					<form class="form-horizontal" action="<?=base_url().'ruangrapat/penghimpunan/update';?>" method="post">
								...
								<div class="form-group">
									<div class="col-md-12 widget-right">
										<div class="baten">
											...
											<div class="baten1">
												<a href="<?=base_url().'ruangrapat/penghimpunan/table'?>" class="btn btn-danger">Cancel</a>
											</div>
										</div>
									</div>
