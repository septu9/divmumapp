 	...
 	.Ditolak{
 		...
 		<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
 			...
 			<div class="panel panel-info">
 				...
 				Table Booking Ruang Meeting</center></div>
 				<div class="panel-body btn-margins">
 					<div class="col-md-12">
 						...
 						<td>
 							...
 							<a href="<?= base_url(); ?>ruangrapat/pendistribusian/ubah/<?= $b['id_booking'] ?> " class="btn btn-sm btn-warning btn-circle "><li class="fa fa-pencil"></li> </a>

 							<a href="<?= base_url(); ?>ruangrapat/pendistribusian/detail/<?= $b['id_booking'] ?> " class="btn btn-sm btn-info btn-circle "><li class="fa fa-list-alt"></li> </a></td>
