...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<fieldset>
				<form class="form-horizontal" action="<?php echo base_url().'mobil/kepatuhan/update' ?>" method="post">
					<fieldset>
						<?php
						...
						<div class="form-group">
							<div class="col-md-12 widget-right">
								<button type="submit" class="btn btn-primary btn-md pull-right">Ubah</button>
								<div class="baten">
									<a href="<?= base_url(); ?>mobil/kepatuhan/table" class="btn btn-warning">Kembali</a>
								</div>
							</div>
						</div>
					</fieldset>
