...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<fieldset>
				<form class="form-horizontal" action="<?php echo base_url().'mobil/Kepatuhan/Kepatuhan' ?>" method="post">
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input id="nama_lengkap" name="nama_lengkap" type="text" placeholder="" class="form-control" value="<?=$user;?>" readonly>
							<br/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-md-12 widget-right">
							<button type="submit" class="btn btn-success btn-md pull-right">Booking</button>
							<div class="baten1">
								<a href="<?=base_url().'mobil/kepatuhan/index';?>" class="btn btn-danger pull-right">Cancel</a>
							</div>
						</div>
					</div>
				</fieldset>
