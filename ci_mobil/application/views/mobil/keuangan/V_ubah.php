	...
	<div class="panel panel-info">
		...
		<?php foreach($booking as $b):?>
			<div class="panel-body">
				<fieldset>
					<form class="form-horizontal" action="<?php echo base_url().'mobil/keuangan/update' ?>" method="post">
						<fieldset>
							<!-- Name input-->
						...
						<div class="form-group">
							<div class="col-md-12 widget-right">
								...
								<div class="baten">
									<a href="<?= base_url(); ?>mobil/keuangan/table" class="btn btn-warning">Kembali</a>
								</div>
							</div>
						</div>
					</fieldset>
