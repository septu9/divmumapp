      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          <div class="panel-heading"><center>
            <i class="fa fa-table">Table Data Mobil</center></i>
          </div>
          ...
          <div class="panel-body">
            <fieldset>
              ...
              <td>
                <h4>
                  <a href="<?= base_url(); ?>mobil/keuangan/detail/<?= $bk['id_booking']; ?>"><span class="label label-info"><i class="fa fa-info"></i></span></a>
                  <a href="<?= base_url(); ?>mobil/keuangan/ubah/<?= $bk['id_booking']; ?>"><span class="label label-warning"><i class="fa fa-edit"></i></span></a>
                </h4>
