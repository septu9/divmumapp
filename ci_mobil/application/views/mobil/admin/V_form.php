...
<div class="col-sm-9 col-sm-offset-1 col-lg-10 col-lg-offset-2 main">
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			<fieldset>
				<form class="form-horizontal" action="<?php echo base_url().'mobil/admin/masukuser' ?>" method="post">
					<!-- Name input-->
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input id="divisi" name="nama_lengkap" type="text" value="<?=$user;?>" placeholder="" class="form-control" readonly>
							<br/>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-md-12 widget-right">
							<div class="baten">
								...
								<a href="<?=base_url().'mobil/admin/index';?>" class="btn btn-danger">Cancel</a>
							</div>
						</div>
					</fieldset>
				</form>
