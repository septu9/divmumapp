...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
	<div class="row">
		<ol class="breadcrumb">
			...
			<li class="active">Booking Mobil</li>
		</ol>
	</div><!--/.row-->

	<div class="row">
		<div class="col-lg-12">
			<h2 class="page-header">Status Mobil</h2>
		</div>
	</div><!--/.row-->
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			foreach ($ubahbooking as $b) :?>
				<form class="form-horizontal" action="<?=base_url().'mobil/status/update';?>" method="post">
					...
					<div class="form-group">
						<div class="col-md-12 widget-right">
							<div class="baten">
								...
								<div class="baten1">
									<a href="<?=base_url().'admin/databooking'?>" class="btn btn-danger">Cancel</a>
								</div>
							</div>
						</div>
