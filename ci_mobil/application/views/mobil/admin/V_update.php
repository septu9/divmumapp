	...
	<div class="panel panel-info">
		...
		<?php foreach ($booking as $b ) :?>
			<div class="panel-body">
				<fieldset>
					<form class="form-horizontal" action="<?php echo base_url().'mobil/admin/update' ?>" method="post">
						<fieldset>
							<!-- Name input-->
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input id="divisi" name="nama_lengkap" type="text" value="<?=$b['nama_lengkap'];?>" placeholder="" class="form-control"readonly>
									<br/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-md-10">
									<input id="waktuakhir" name="waktuakhir" type="time" value="<?= $b['waktu_selesai']; ?>" placeholder="" class="form-control">
								</div>
							</div>
						<?php endforeach;?>
						...
						<div class="form-group">
							<div class="col-md-12 widget-right">
								...
								<div class="baten">
									<a href="<?= base_url(); ?>mobil/admin/databooking" class="btn btn-warning">Cancel</a>
								</div>
							</div>
						</div>
					</fieldset>
