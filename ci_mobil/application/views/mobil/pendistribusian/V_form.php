...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <fieldset>
        <form class="form-horizontal" action="<?php echo base_url().'mobil/pendistribusian/pendistribusian' ?>" method="post">
          ...
          <div class="form-group">
            <div class="col-md-12 widget-right">
              ...
              <div class="baten1">
                <a href="<?=base_url().'pendistribusian/index';?>" class="btn btn-warning pull-right">Cancel</a>
              </div>
            </div>
          </div>
        </fieldset>
