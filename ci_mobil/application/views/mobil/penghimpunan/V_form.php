...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
  <div class="row">
    <ol class="breadcrumb">
      <li><a href="<?=base_url();?>pendistribusian/index">
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
      <fieldset>
        <form class="form-horizontal" action="<?php echo base_url().'mobil/penghimpunan/penghimpunan' ?>" method="post">
        ...
        <div class="form-group">
          ...
          <div class="col-md-10">
            <input id="divisi" name="" type="text" value="Penghimpunan dan Publikasi" placeholder="" class="form-control" readonly>
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="form-group">
        <div class="col-md-12 widget-right">
          ...
          <div class="baten1">
            <a href="<?=base_url().'penghimpunan/index';?>" class="btn btn-danger pull-right">Cancel</a>
          </div>
        </div>
      </div>
    </fieldset>
