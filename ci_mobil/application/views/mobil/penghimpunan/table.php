...
.Disetujui{
  ...
  .Ditolak{
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
      <div class="row">
        <ol class="breadcrumb">
          <li><a href="<?=base_url();?>penghimpunan/index">
      ...
      <div class="col-md-12">
        <div class="panel panel-primary">
          ...
          Table Peminjaman Mobil</center></i>
        </div>
        <div class="panel-body">
          <fieldset>
            ...
            <td>
              <h4>
                <a href="<?= base_url(); ?>mobil/penghimpunan/detail/<?= $bk['id_booking']; ?>"><span class="label label-info"><i class="fa fa-info"></i></span></a>
                <a href="<?= base_url(); ?>mobil/penghimpunan/ubah/<?= $bk['id_booking']; ?>"><span class="label label-warning"><i class="fa fa-edit"></i></span></a>
              </h4>
